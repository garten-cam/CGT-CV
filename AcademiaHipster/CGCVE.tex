...
\begin{paracol}{2}
	...
	{\setasidefontcolour
		...
		\begin{minipage}[t]{0.3\textwidth}
			\begin{tabular}{r @{\hspace{0.5em}}l}
				\bg{skilllabelcolour}{iconcolour}{\LaTeX} & \barrule{0.55}{0.5em}{cvred}    \\
				\bg{skilllabelcolour}{iconcolour}{MATLAB} & \barrule{0.55}{0.5em}{cvred}    \\
				\bg{skilllabelcolour}{iconcolour}{Linux}  & \barrule{0.45}{0.5em}{cvpurple} \\
	...
	\begin{tabular}{r| p{0.5\textwidth}}
		\cvevent{2020--202x}{Post-Doctoral Researcher}{Researcher}{Universit\'e de Mons}{Data-driven (Machine Learning) model and control of Industrial lime production. Python and Matlab algorithm based on EDMD.}                                              \\
	...
	\begin{minipage}[t]{0.3\textwidth}
		...
		\begin{tabular}{>{\footnotesize\bfseries}r >{\footnotesize}p{0.6\textwidth}}
			2023 & ``Development of Accurate and Tractable Edmd Approximations for Analysis and Control'', at: \emph{SIAM-DS} in Portland, Oregon.
		\end{tabular}
	\end{minipage}
